...
public class PrincipalRequestFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext)
        ...
        if (requestContext.getUriInfo().getPath().equals("/api/v1/authenticate") || requestContext.getUriInfo().getPath().equals("/api/v1/authenticate/token") || requestContext.getUriInfo().getPath().equals("/api/v1/users")){
